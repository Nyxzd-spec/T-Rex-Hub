...
FileName = "T-RexHubGui"
CreateWindow = Rayfield:CreateWindow({
   Name = "T-Rex Hub",
   LoadingTitle = "T-Rex Hub",
   LoadingSubtitle = "by T-Rex",
   ConfigurationSaving = {
      Enabled = true,
   ...
   KeySettings = {
      ...
      Key = {"Hello"} -- List of keys that will be accepted by the system, can be string or number
   }
})
...
Local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      Enabled = false,
      Invite = "https://discord.gg/RMdTf3HD8X", -- The Discord invite code, do not include discord.gg/
      RememberJoins = true -- Set this to false to make them join the discord every time they load it up
   },
   KeySystem = false,
   KeySettings = {
      Title = "T-Rex Hub",
      Subtitle = "Key System",
      Note = "Join the discord (discord.gg/RMdTf3HD8X)",
      FileName = "TRexKey",
      SaveKey = true,
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"Beta"} -- List of keys that will be accepted by the system, can be string or number
    }
})

local Tab = Window:CreateTab("T-RexHub", 4483362458) -- Title, Image
local tab = Window:CreateTab("Tab Example", "rewind")
local section = Tab:CreateSection("T-RexHub")
Section:Set("T-RexHub")

Local Divider = Tab:CreateDivider()
Divider:Set(false) -- Whether the divider's visibility is to be set to true or false.

Rayfield:SetVisibility(true) -- Set this to false if you want to hide the whole menu
Rayfield:IsVisible() -- Returns 'true' if the menu is visible, 'false' if not
Rayfield:Destroy() -- Destroys the menu and all of its content

Rayfield:Notify({
   Title = "T-Rex Hub",
   Content = "Welcome to T-Rex Hub!",
   Duration = 5,
    Image = 4483362458,
})
Rayfield:Notify({
   Title = "T-Rex Hub",
   Content = "Join the discord for more scripts!",
   Duration = 5,
    Image =  "rewind",
})
...
Button:Set("Button Example") -- Sets the button's name to "Button Example"
...
local Toggle = Tab:CreateToggle({
   ...
   Callback = function(Value)
      print("The toggle is: ", Value) -- The boolean value of the toggle will be returned to the function as the argument
   end,
})
Toggle:Set(false) -- Sets the toggle to false
local ColorPicker = Tab:CreateColorPicker({
   Name = "Color Picker Example",
   Default = Color3.fromRGB(255, 255, 255),
   Flag = "ColorPicker1", -- A flag is the identifier for the configuration file, make sure every element has a different flag if you're using configuration saving to ensure no overlaps
   Callback = function(Value)
      print("The color picker value is: ", Value) -- The Color3 value of the color picker will be returned to the function as the argument
   end,
})
ColorPicker:Set(Color3.fromRGB(255, 255, 255)) -- Sets the color picker to white
...
Local Slider = Tab:CreateSlider({
   ...
   Callback = function(Value)
      print("The slider value is: ", Value) -- The number value of the slider will be returned to the function as the argument
   end,
})
Slider:Set(50) -- Sets the slider to 50
...
Local Input = Tab:CreateInput({
   ...
   Callback = function(Value)
      print("The input value is: ", Value) -- The string value of the input will be returned to the function as the argument
   end,
})
Input:Set("Hello World!") -- Sets the input to "Hello World!"
...
Local Dropdown = Tab:CreateDropdown({
   ...
   Callback = function(Value)
      print("The dropdown value is: ", Value) -- The string value of the dropdown will be returned to the function as the argument
   end,
})
Dropdown:Set("Option 1") -- Sets the dropdown to "Option 1"
Dropdown:Add("Option 4") -- Adds "Option 4" to the dropdown
Rayfield.Flags
...
local Divider = Tab:CreateDivider()
Divider:Set(false) -- Visible[true/false]
...
local Window = Fluent:CreateWindow({Title = "🦖T-Rex Hub🦖 [Version:V1]",SubTitle = "| By Nyx",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Dark",MinimizeKey = Enum.KeyCode.End})
...
local Tabs = {
  ...
  Combat = Window:AddTab({Title = "Visual/Combat", Icon = "user"}),
  Settings = Window:AddTab({Title = "Settings", Icon = "rbxassetid://7734053495"}),
  Main = Window:AddTab({Title = "Farm", Icon = "home"}),
  Melee = Window:AddTab({Title = "Artes marciais", Icon = "rbxassetid://11162889532"}),
  Quests = Window:AddTab({Title = "Quest/Itens", Icon = "rbxassetid://13075622619"}),
